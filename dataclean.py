...
directory = '2022-06-09data/testchagerate.xlsx'
...
#         df_cleaned = process_file(file_path, start_date,end_date)
...
#     'backers_count', 'state','blurb','country_displayable_name','usd_exchange_rate'
# ]
# final_df = merged_df[selected_columns]
# # # # #
# # # # # # 保存到新的 Excel 文件
# output_file_path = os.path.join(directory, 'FinalMerged_kickstarter_rate_data.xlsx')
...
#
# # 新的命名
# output_file_path = '2022-06-09data/testchagerate.xlsx'
...
print_correlation(df,'backers_count', 'state')
print_correlation(df,'duration', 'usd_pledged')
print_correlation(df,'duration', 'state')
print_correlation(df,'duration', 'backers_count')
print_correlation(df,'state', 'usd_pledged')
print_correlation(df,'state', 'usd_goal')

#
print("\nDirect spearman_correlation without Z-score filtering:")
print_spearman_correlation(df,'backers_count', 'usd_pledged')
print_spearman_correlation(df,'backers_count', 'state')
print_spearman_correlation(df,'duration', 'usd_pledged')
print_spearman_correlation(df,'duration', 'state')
print_spearman_correlation(df,'duration', 'backers_count')
print_spearman_correlation(df,'state', 'usd_pledged')
print_spearman_correlation(df,'state', 'usd_goal')
# plt.scatter(Xbb,Ydd)
# plt.show()